...
namespace project.Migrations
{
    ...
    [Migration("20251020124044_addedDescriptionAndIconUrlPropertiesToCategory")]
    partial class addedDescriptionAndIconUrlPropertiesToCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("project.Model.CartItem", b =>
                {
                    ...
                    b.HasOne("project.Model.ShoppingCart", "ShoppingCart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("project.Model.ShoppingCart", b =>
                {
                    b.HasOne("project.Model.Customer", "Customer")
                        ...
                        .HasForeignKey("project.Model.ShoppingCart", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
